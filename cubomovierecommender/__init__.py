...
r_df = pd.read_csv(library_path + '/data/ratings.csv', sep=',', index_col=[1]) # read in from hard-drive
movies = pd.read_csv(library_path + '/data/movies.csv', sep=',', index_col=[0]) # read in from hard-drive
